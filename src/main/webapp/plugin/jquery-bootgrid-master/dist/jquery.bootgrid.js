    ...
    */
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div id=\"buttons_id\" class=\"col-sm-5\"></div><div class=\"col-sm-7 actionBar\"><p class=\"{{css.search}}\"></p><p class=\"{{css.actions}}\"></p></div></div></div>",
