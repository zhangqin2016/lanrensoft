    ...
    private String getFormField(Table table){
        ...
        for (TableColumn column : table.getListColumn()) {
            ...
            if(columnTilte.indexOf(BuildTool.IMAGE)!=-1){
                ...
                htmlImg.append("<label for=\""+columnName+"\" class=\"col-sm-2 control-label\">"+columnTilte.replace(BuildTool.IMAGE, "")+"</label>\r\n ");
                htmlImg.append("<div class=\"col-sm-3\">\r\n ");
                htmlImg.append("<input type=\"file\"id=\""+columnName+"_file\" class=\"form-control\" value='${"+table_name+"."+columnName+"!}' >\r\n ");
                htmlImg.append("<input type=\"hidden\" id=\""+columnName+"\"  name=\""+columnName+"\"class=\"form-control\" value='${"+table_name+"."+columnName+"!}' > \r\n ");
                htmlImg.append("</div>\r\n ");
                htmlImg.append("  	<div class=\"col-sm-4\">\r\n ");
                htmlImg.append("  	<img id=\""+columnName+"_file_show\" src=\"${"+table_name+"."+columnName+"!}\" style=\"width:100px;\" alt=\"图片\" class=\"img-rounded\">  \r\n ");
                htmlImg.append("</div>\r\n ");
                htmlImg.append("</div>\r\n ");
                ...
                htmlImg.append("<div class=\"form-group\" >\r\n ");
                htmlImg.append("<label for=\""+columnName+"\" class=\"col-sm-2 control-label\">"+columnTilte.replace(BuildTool.FILE, "")+"</label>\r\n ");
                htmlImg.append("<div class=\"col-sm-3\">\r\n ");
                htmlImg.append("<input type=\"file\"id=\""+columnName+"_file\" class=\"form-control\" value='${"+table_name+"."+columnName+"!}' >\r\n ");
                htmlImg.append("<input type=\"hidden\" id=\""+columnName+"\"  name=\""+columnName+"\"class=\"form-control\" value='${"+table_name+"."+columnName+"!}' > \r\n ");
                htmlImg.append("</div>\r\n ");
                htmlImg.append("  	<div class=\"col-sm-4\">\r\n ");
                htmlImg.append("  	<a id=\""+columnName+"_file_show\" href=\"${"+table_name+"."+columnName+"!}\" style=\"width:100px;\" >${"+table_name+"."+columnName+"!} </a> \r\n ");
                htmlImg.append("</div>\r\n ");
                htmlImg.append("</div>\r\n ");
                htmlImg.append("  <script type=\"text/javascript\"> \r\n ");
                htmlImg.append("$(document).ready(function()  \r\n ");
            ...
            if(typeName.equals("text")){
                ...
                htmlText.append("<label for=\"xm\" class=\"col-sm-2 control-label\">"+columnTilte+"</label>\r\n ");
                htmlText.append("<div class=\"col-sm-8\">\r\n ");
                htmlText.append("<textarea name=\""+columnName+"\" id=\""+columnName+"\" style=\"width: 100%\">${"+table_name+"."+columnName+"!}</textarea>\r\n ");
                ...
                htmlRadio.append("<label for=\"xm\" class=\"col-sm-2 control-label\">"+showLabel+"</label>\r\n ");
                ...
                htmlRadio.append("if('${"+table_name+"."+columnName+"!}'==this.value){ \r\n ");
                ...
                htmlSelect.append("	$(\"#"+columnName+"\").val(\"${"+table_name+"."+columnName+"!}\");\r\n ");
                htmlSelect.append("	if('${"+table_name+"."+columnName+"!}'==''){\r\n ");
            ...
            }else
            {
                ...
                html.append("<label for=\"xm\" class=\"col-sm-2 control-label\">"+columnTilte+"</label>\r\n ");
                ...
                html.append("<input  type=\"text\" "+focus+" name=\""+columnName+"\" id=\""+columnName+"\" class=\"form-control\" "+checkedType+" value='${"+table_name+"."+columnName+"!}' >\r\n ");
                html.append("</div>\r\n ");
                html.append(" </div>\r\n ");
            }
        }
