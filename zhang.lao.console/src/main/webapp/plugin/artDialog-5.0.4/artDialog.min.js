...
!function (a, b) {
    ...
    return a.$ === b && (a.$ = c), c.fn = c.prototype = {
        constructor: function (a, b) {
            ...
            var a = this[0], b = a.getBoundingClientRect(), c = a.ownerDocument, d = c.body, e = c.documentElement, f = e.clientTop || d.clientTop || 0, g = e.clientLeft || d.clientLeft || 0, h = b.top + (self.pageYOffset || e.scrollTop) - f, i = b.left + (self.pageXOffset || e.scrollLeft) - g;
            return {left: i, top: h}
        }, html: function (a) {
            var d = this[0];
    ...
    var d, e = 0, g = (a(document.getElementsByTagName("html")[0]), "artDialog" + +new Date), h = b.VBArray && !b.XMLHttpRequest, i = "createTouch" in document && !("onmousemove" in document) || /(iPhone|iPad|iPod)/i.test(navigator.userAgent), j = !h && !i, k = function () {
        try {
    ...
    m.version = "5.0.4", m.fn = m.prototype = {
        _create: function (a) {
            ...
            var a = this.dom, b = a.wrap[0], c = a.window, d = a.document, e = this.config.fixed, f = e ? 0 : d.scrollLeft(), h = e ? 0 : d.scrollTop(), i = c.width(), j = c.height(), k = b.offsetWidth, l = b.offsetHeight, m = (i - k) / 2 + f, n = 382 * (j - l) / 1e3 + h, o = b.style;
            ...
            var e = d.fixed, f = g + "follow", h = this.dom, i = h.window, j = h.document, k = i.width(), l = i.height(), m = j.scrollLeft(), n = j.scrollTop(), o = c.offset(), p = b.offsetWidth, q = b.offsetHeight, r = e ? o.left - m : o.left, s = e ? o.top - n : o.top, t = this.dom.wrap[0], u = t.style, v = t.offsetWidth, w = t.offsetHeight, x = r - (v - p) / 2, y = s + q, z = e ? 0 : m, A = e ? 0 : n;
            ...
            var c = this, e = (this.config, this.dom), f = document.createElement("div"), g = a(f), h = m.defaults.zIndex - 1;
