...
public class LineTest {
    ...
    public void testALinesetLine() {
        ...
        try {
            ImageIO.write((RenderedImage) imageCode.getImage(), "png", new File("e:/codeerTest/" + imageCode.getCode() + "_ALine.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void testBLinesetLine() {
        ...
        try {
            ImageIO.write((RenderedImage) imageCode.getImage(), "png", new File("e:/codeerTest/" + imageCode.getCode() + "_BLine.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void testALine_BLinesetLine() {
        ...
        bLine.setLine((BufferedImage) imageCode.getImage());
        try {
            ImageIO.write((RenderedImage) imageCode.getImage(), "png", new File("e:/codeerTest/" + imageCode.getCode() + "_ALine_BLine.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void testAllLine_AllCodder() {
        ...
        try {
            for (CaptchaTypeEnum typeEnum : CaptchaTypeEnum.values()) {
                ...
                if (null != imageCode.getImage()) {
                    aLine.setLine((BufferedImage) imageCode.getImage());
                    ImageIO.write((RenderedImage) imageCode.getImage(), "png", new File("e:/codeerTest/" + imageCode.getCode() + "_" + typeEnum.toString() + "_ALine.png"));
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
        ...
        try {
            for (CaptchaTypeEnum typeEnum : CaptchaTypeEnum.values()) {
                ...
                if (null != imageCode.getImage()) {
                    bLine.setLine((BufferedImage) imageCode.getImage());
                    ImageIO.write((RenderedImage) imageCode.getImage(), "png", new File("e:/codeerTest/" + imageCode.getCode() + "_" + typeEnum.toString() + "_BLine.png"));
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
        ...
        try {
            for (CaptchaTypeEnum typeEnum : CaptchaTypeEnum.values()) {
                ...
                if (null != imageCode.getImage()) {
                    ...
                    ImageIO.write((RenderedImage) imageCode.getImage(), "png", new File("e:/codeerTest/" + imageCode.getCode() + "_" + typeEnum.toString() + "_ALine_BLine.png"));
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
